...
export {
  ...
  criarFiado,
  atualizarFiado,
  listarLancamentosFiado,
  registrarDebitoFiado,
  registrarPagamentoFiado,
  criarExtratoImportado,
  listarExtratosPorConta,
  criarLinhasExtrato,
  listarLinhasExtrato,
...
export {
  ...
  customerInteractionsRelations,
  marketingSettingsTable,
  marketingSettingsRelations,
  loyaltyPrizesTable,
  loyaltyPrizesRelations,
