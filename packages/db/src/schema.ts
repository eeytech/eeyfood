...
export const diningTablesTable = pgTable("DiningTable", {
  ...
  displayOrder: integer("displayOrder").default(0).notNull(),
  isActive: boolean("isActive").default(true).notNull(),
  minimumConsumption: doublePrecision("minimumConsumption").default(0).notNull(),
...
export const productsTable = pgTable("Product", {
  ...
  productionSectorId: uuid("productionSectorId").references(
    () => productionSectorsTable.id,
    { onDelete: "set null" },
  ),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().notNull(),
...
export const marketingSpendTable = pgTable("MarketingSpend", {
  ...
  amountSpent: doublePrecision("amountSpent").notNull(),
  notes: text("notes"),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().notNull(),
});
...
export const walletsTable = pgTable(
  "Wallet",
  {
    ...
    creditBalance: doublePrecision("creditBalance").default(0).notNull(),
...
export const marketplaceIntegrationsTable = pgTable("MarketplaceIntegration", {
  ...
  menuMappings: jsonb("menuMappings").$type<Record<string, string>>(),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().notNull(),
}, (table) => ({
  restaurantTypeUniqueIndex: uniqueIndex("marketplace_integration_restaurant_type_unique").on(
    table.restaurantId,
    table.type,
  ),
}));
...
export const courierTripsTable = pgTable("CourierTrip", {
  ...
  commissionAmount: doublePrecision("commissionAmount").default(0).notNull(),
...
export const ordersTable = pgTable("Order", {
  ...
  cashRegisterShiftId: uuid("cashRegisterShiftId").references(
    () => cashRegisterShiftsTable.id,
    { onDelete: "set null" },
  ),
  serviceFeePercent: doublePrecision("serviceFeePercent"),
  serviceFeeAmount: doublePrecision("serviceFeeAmount").default(0).notNull(),
  paymentSplits: jsonb("paymentSplits")
    .$type<Array<{ method: string; amount: number }>>(),
  ...
  customerLedgerId: uuid("customerLedgerId").references(
    () => customerLedgersTable.id,
    { onDelete: "set null" },
  ),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().notNull(),
...
export const inventoryLossesTable = pgTable("InventoryLoss", {
  ...
  financialLoss: doublePrecision("financialLoss").default(0).notNull(),
  notes: text("notes"),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().notNull(),
});
...
export const cashRegisterShiftsTable = pgTable("CashRegisterShift", {
  ...
  closedAt: timestamp("closedAt"),
  openingAmount: doublePrecision("openingAmount").default(0).notNull(),
  expectedClosingAmount: doublePrecision("expectedClosingAmount"),
  actualClosingAmount: doublePrecision("actualClosingAmount"),
  closingDifference: doublePrecision("closingDifference"),
...
export const comandasAvulsasTable = pgTable(
  "ComandaAvulsa",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    restaurantId: uuid("restaurantId")
  ...
  (table) => ({
    restaurantNumeroUniqueIndex: uniqueIndex(
      "comanda_avulsa_restaurant_numero_unique",
    ).on(table.restaurantId, table.numero),
  }),
);
...
export const customerLedgersTable = pgTable("CustomerLedger", {
  ...
  customerPhone: text("customerPhone"),
  customerCpf: text("customerCpf"),
  creditLimit: doublePrecision("creditLimit").default(200).notNull(),
  debtBalance: doublePrecision("debtBalance").default(0).notNull(),
  isActive: boolean("isActive").default(true).notNull(),
  notes: text("notes"),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().notNull(),
...
export const bankStatementEntriesTable = pgTable("BankStatementEntry", {
  ...
  matchedTransactionId: uuid("matchedTransactionId").references(
...
export const productionSectorsRelations = relations(
...
export const cashRegisterShiftsRelations = relations(
...
export const customersTable = pgTable(
  "Customer",
  {
    ...
    avgTicket: doublePrecision("avgTicket").default(0).notNull(),
    totalOrders: integer("totalOrders").default(0).notNull(),
  ...
  (table) => ({
    restaurantPhoneUniqueIndex: uniqueIndex("customer_restaurant_phone_unique").on(
      table.restaurantId,
      table.phone,
    ),
  }),
