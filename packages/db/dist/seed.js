...
const main = async () => {
    await db.transaction(async (tx) => {
        ...
        await tx.insert(productsTable).values([
            {
                ...
                description: "Quatro hambúrgueres, alface americana, queijo cheddar, molho especial, cebola, picles e pão com gergelim, acompanhamento e bebida.",
                price: 39.9,
            ...
            },
            {
                ...
                description: "Dois hambúrgueres bovinos, maionese especial, onion rings, bacon, queijo cheddar e molho cremoso no pão brioche, com acompanhamento e bebida.",
                price: 41.5,
            ...
            },
            {
                ...
                description: "Pão brioche com batata, molho Honey&Fire, bacon, alface, tomate, cheddar e filé de peito de frango empanado, com acompanhamento e bebida.",
                price: 39.9,
        ...
        await tx.insert(productsTable).values([
            {
                name: "Big Mac",
                description: "Quatro hambúrgueres bovinos, alface americana, cheddar, molho especial, cebola, picles e pão com gergelim.",
                ingredients: [
                    "Pão com gergelim",
                    "Hambúrguer bovino",
                    "Alface americana",
            ...
            },
            {
                ...
                description: "Dois hambúrgueres bovinos, maionese especial, bacon, cheddar e molho cremoso no pão brioche.",
                ingredients: [
                    "Pão brioche",
                    "Hambúrguer bovino",
                    "Maionese especial",
            ...
            {
                name: "McMelt",
                description: "Pão brioche, molho Honey&Fire, bacon, alface, tomate, cheddar e frango empanado.",
                ingredients: [
                    "Pão brioche",
                    "Molho Honey&Fire",
                    "Bacon",
