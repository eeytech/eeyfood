...
const main = async () => {
    await db.transaction(async (tx) => {
        ...
        await tx.insert(aiSettingsTable).values({
            ...
            botName: "Craft Bot",
            systemPrompt: "Você é o Craft Bot, atendente virtual da Burger Craft SP. Seja simpático e objetivo. " +
        ...
        const [sectorQuente, sectorFria, sectorBar] = await tx
            ...
            .returning();
        const [catCombos, catLanches, catPizzas, catFritas, catBebidas, catSobremesas, catSorvetes, catAcai,] = await tx
        ...
        const [prodBigCraft, prodDuploCostela, prodFrangoChispy, prodComboClassico, prodComboFrango, prodFritasG, prodFritasP, prodCocaCola, , , , prodPizzaCalabresa, prodPizzaMargherita, prodPizzaQuatroQueijos, prodPizzaFrangoCatupiry, prodPizzaPepperoni, prodPizzaPortuguesa,] = await tx
            ...
            .values([
            {
                ...
                name: "Big Craft",
                description: "180g de costela bovina, cheddar artesanal, alface, tomate, picles e molho especial no pão brioche.",
                price: 35.0,
                costPrice: 14.7,
            ...
            },
            {
                ...
                productionSectorId: sectorQuente.id,
                name: "Duplo Costela",
                description: "Dois discos de costela 180g, bacon crocante, cheddar duplo, cebola caramelizada e aioli trufado.",
                price: 42.0,
                costPrice: 17.64,
            ...
            },
            {
                ...
                productionSectorId: sectorQuente.id,
                name: "Frango Crispy",
                description: "Filé de frango empanado crocante, maionese de alho, alface e tomate no pão brioche.",
                price: 32.0,
                costPrice: 13.44,
        ...
        const [prodTridentMenta, prodTridentMelancia, prodHallsPreto, prodHallsMorango, prodKitKat, prodBarraChocolate, prodBrownieNutella,] = await tx
            .insert(productsTable)
            .values([
            {
                restaurantId: restaurant.id,
        ...
        const [prodPicoleMorango, prodPicoleNinhoNutella, prodPicoleChocBelga, prodPicoleLimao, prodPoteSorvete500, prodPoteSorvete1L,] = await tx
            .insert(productsTable)
            .values([
            {
                restaurantId: restaurant.id,
            ...
            .returning();
        // ── Açaí ──
        const [prodAcaiCopo, prodAcaiTigela,] = await tx
            .insert(productsTable)
            .values([
            {
                restaurantId: restaurant.id,
        ...
        const [invPaoBrioche, invHamburgerCostela, invQueijoCheddar, invBaconTiras, invAlfaceAmericana, invTomateFresco, invBatataCongelada, invCocaColaLata, invEmbalagBurger, invMassaPizza,] = await tx
